...
public class LambdaExpressions {
	...
	public static void main(String[] args) {
		...
		System.out.println("Nombre de personnes mariÃ©es: " + filterPredicate(listPersons, isMarriedPredicate)); //2
		System.out.println();
		...
		//Utilisation de l'objet Random pour generer aléatoirement des numéros
		...
		//Manipulations des nouvelles méthodes dans l'interface Map
        ...
        // computeIfAbsent:
        // vérifie si la clé n'est pas présente donc elle ajoute la valeur ou
        // si la clé existe mais la valeur est égale à null donc elle met à jour la valeur
        ...
        //computeIfPresent:
        //modifie seulement si la clé existe
        ...
        //Merge
        //Merger entre la clé et la valeur 
	...
	// MÃ©thode qui montre l'utlisation de predicate
	...
	// MÃ©thode qui montre l'utlisation de Consumer
	...
	// MÃ©thode qui montre l'utlisation de Function
